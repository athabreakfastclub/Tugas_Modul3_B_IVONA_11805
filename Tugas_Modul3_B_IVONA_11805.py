...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1805</h1>", unsafe_allow_html=True)
...
uploaded_file = st.sidebar.file_uploader("Uploader file dataset_regresi_IPK.csv", type=["csv"])
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\ASUS\Downloads\Tugas3_B_11805'
    ...
    if os.path.exists(model_path):
        ...
        #kkm
        st.sidebar.subheader("Masukkan Nilai")
        kkm_mtk1 = st.sidebar.number_input("Nilai Matematika Semester 1.1", 0.0, 100.0)
        kkm_mtk2 = st.sidebar.number_input("Nilai Matematika Semester 1.2", 0.0, 100.0)
        kkm_mtk3 = st.sidebar.number_input("Nilai Matematika Semester 2.1", 0.0, 100.0)
        kkm_mtk4 = st.sidebar.number_input("Nilai Matematika Semester 2.2", 0.0, 100.0)
        kkm_ing1 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.1", 0.0, 98.0)
        kkm_ing2 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.2", 0.0, 99.0)
        kkm_ing3 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.1", 0.0, 99.0)
        kkm_ing4 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.2", 0.0, 99.0)
        kkm_ind1 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.1", 0.0, 100.0)
        kkm_ind2 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.2", 0.0, 100.0)
        kkm_ind3 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.1", 0.0, 100.0)
        kkm_ind4 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.2", 0.0, 100.0)      
        ...
        st.error("Model tidak ditemukan, silakan cek fle model di direktori.")